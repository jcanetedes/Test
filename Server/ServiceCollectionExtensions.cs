...
namespace BlazorApp2.Server
{
    public static class ServiceCollectionExtensions
    {
        ...
        private static void LoadAssemblies()
        {
            ...
            foreach (var dll in assembliesFolder.EnumerateFiles($"*.dll", SearchOption.TopDirectoryOnly).Where(f => f.Name.Contains("Module", StringComparison.OrdinalIgnoreCase)))
            {
        ...
        private static IServiceCollection AddOqtaneServices(this IServiceCollection services)
        {
            ...
            var assemblies = AppDomain.CurrentDomain.GetAssemblies().Where(a => a.FullName != null && (a.FullName.Contains("Module", StringComparison.OrdinalIgnoreCase)));
